export function FourthSection() {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col justify-center mt-20 gap-20 mx-auto">
        <div className="flex gap-40">
          <div className="flex flex-col py-2 justify-center px-4 bg-white rounded-xl w-[512px] h-[192px] gap-2">
        ...
        <div className="flex gap-40">
          <div className="flex flex-col py-2 justify-center px-4 bg-white rounded-xl w-[512px] h-[192px] gap-2">
            <h1 className="text-brown font-bold">Manuela Murphy</h1>
            <p>
          ...
          <div className="flex flex-col py-2 justify-center px-4 bg-white rounded-xl w-[512px] h-[192px] gap-2">
            <h1 className="text-brown font-bold">Livia Oliveira</h1>
